...
public class FoxIncrementAgeTest {
	...
	public void setUp() throws Exception {
		this.foxOne = new Fox(false, new Field(20, 20), new Location(10, 10), 100);
		this.foxTwo = new Fox(false, new Field(20, 20), new Location(10, 10), 100);
		this.foxThree = new Fox(false, new Field(20, 20), new Location(10, 10), 100);
		this.foxFour = new Fox(false, new Field(20, 20), new Location(10, 10), 100);
	}
